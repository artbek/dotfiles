...
if &t_Co > 255
  ...
  highlight Cursor          ctermfg=0       ctermbg=none     cterm=none
  ...
  if g:kolor_bold==0
    ...
    highlight Search          ctermfg=0     ctermbg=208    cterm=none
    ...
    if g:kolor_alternative_matchparen==0
      ...
      highlight MatchParen      ctermfg=247     ctermbg=none     cterm=none
    endif
  else
    highlight ErrorMsg        ctermfg=168     ctermbg=none    cterm=bold
    highlight Search          ctermfg=0     ctermbg=208    cterm=bold
    ...
    if g:kolor_alternative_matchparen==0
      ...
      highlight MatchParen      ctermfg=247     ctermbg=none     cterm=bold
    endif
  endif
  if g:kolor_underlined==0
